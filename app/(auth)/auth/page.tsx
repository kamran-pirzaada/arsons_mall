...
import { getSignupFormData, handleSignupSubmit } from '@/action/auth/signup';

import { getLoginFormData, handleLoginSubmit } from '@/action/auth/login';
        ...
        <div>
          ...
          <div>
            ...
            <p className='text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8'>
              {isSignUp
                ? 'Shop smarter at ArsonsMall! Join today and unlock exclusive deals, hot offers, and your favorite products at unbeatable prices!'
                : 'Welcome back to ArsonsMall! Log in now and continue exploring amazing deals on your favorite products!'}
            </p>
          </div>
